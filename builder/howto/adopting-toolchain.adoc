...
====
.Summary
The easiest way to adopt StanDoc is to use the metanorma-acme gem: https://github.com/metanorma/metanorma-acme, supplying your own stylesheets and HTML files for styling. See link:/builder/howto/simple-adoption/[Simple Adoption] for more information.
...
See link:/builder/howto/metadata-and-boilerplate/[Metadata and Boilerplate] for more information.
