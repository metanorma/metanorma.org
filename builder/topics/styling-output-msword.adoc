...
* CSS in Word HTML is entered within XML comments, and `--` is illegal within XML comments. As a workaround, any instances of `--` in SCSS stylesheets is entered as `-&#200c;-`; the `&#200c;` is stripped in post-processing.
