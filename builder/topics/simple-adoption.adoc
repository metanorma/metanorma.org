...
`i18nyaml`:: YAML file to be used for internationalisation and labels [added in https://github.com/metanorma/metanorma-generic/releases/tag/v1.6.3].

`published_stages`:: list of stages considered published

`committees`:: list of legal committee values
