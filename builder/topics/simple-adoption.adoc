...
`metanorma_name`:: Short name of the Metanorma flavour for use in invoking the gem [added in https://github.com/metanorma/metanorma-generic/releases/tag/v1.4.8]
