...
//This file contains all the lessons for the tutorials. Since there was no template while Tina contributed to Metanorma, you'll find all lessons here, and you can copy the includes into the tutorial templates later.
...
include::learn/learning-objectives.adoc[tag=learningobjectives-1]
...
include::learn/learning-objectives.adoc[tag=learningobjectives-2]
...
include::author/topics/inline-markup/text-formatting.adoc[tag=tutorial,leveloffset=+2]

==== Footnotes

include::author/topics/inline-markup/footnotes.adoc[tag=tutorial]
...
include::author/topics/inline-markup/index-terms.adoc[tag=tutorial]
...
include::author/topics/inline-markup/links.adoc[tag=tutorial]
...
include::learn/learning-objectives.adoc[tag=learningobjectives-3]
...
include::learn/learning-objectives.adoc[tag=learningobjectives-4]
