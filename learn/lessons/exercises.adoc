...
* [ ] Add a footnote on line 30 to explain the OGC Innovation Program. Footnote text: See all active initiatives at the OGC website. link:https://www.ogc.org/projects/initiatives/active[].
// end::exercise-2-4-1
