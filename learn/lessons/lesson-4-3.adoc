...
[NOTE]
====
Beyond local compilation, Metanorma supports automated publishing: documents
can be compiled in CI, released as GitHub Releases with channel metadata, and
aggregated into an organization portal. See
link:/install/publication-setup/[Organization-Scale Publishing Setup] for details.
====
