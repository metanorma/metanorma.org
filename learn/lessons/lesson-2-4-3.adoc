...
If you want to learn more about the technical aspects of cross-references, read link:author/basics/cross-references.adoc[Deep-dive into cross-references].
