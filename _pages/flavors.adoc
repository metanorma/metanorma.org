...
following organizations, as distinct implementations ("flavors" of Metanorma).
...
|Japanese Ministry of Land, Infrastructure, Transport and Tourism, Project PLATEAU
| link:/author/plateau/[Metanorma for PLATEAU]
...
Metanorma supports generation of standardization deliverables for the
following organizations, as configuration-only customizations of existing Metanorma flavors
("tastes").

[cols="h,a"]
|===
|Standards body | Base Flavor

|International Color Consortium | `iso`
|Express Language Foundation | `iso`
|Enosema Foundation | `iso`
|Cloud Security Alliance | `generic`
|PDF Association | `ribose`
|Spatial Web Foundation | `ribose`
|MBx Interoperability Forum | `ribose`
