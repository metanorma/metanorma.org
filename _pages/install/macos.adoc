...
NOTE: This is only necessary for a developer installation of Metanorma.
...
NOTE: Very large documents may trigger a "Too many open files" error on macOS.
A setting of `ulimit -n 1024` on the shell is recommended to avoid this issue.
