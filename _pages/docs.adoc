...
link:/install/site[Site generation*: I want to build a site from my documents.]

link:/install/publication-setup[Publishing*: I want to set up organization-scale document publishing with releases, channels, and portal aggregation.]

link:/reference/[Reference documentation*: I need to look up an attribute.]
...
link:/install/cicd[CI/CD reference*: I want to integrate Metanorma into my CI pipeline.]
