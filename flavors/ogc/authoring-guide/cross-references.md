...
const outputKey = 'author/ogc/authoring-guide/cross-references'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/ogc/authoring-guide/cross-references.json')
