...
const outputKey = 'author/ogc/authoring-guide/text-formatting'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/ogc/authoring-guide/text-formatting.json')
