...
== Text markup
include::author/topics/inline-markup/text-formatting.adoc[tag=text-markup]
include::author/ogc/topics/markup/[tag=inline-ogc]
include::author/topics/inline-markup/text-formatting.adoc[tag=char-subs]
== Footnotes
