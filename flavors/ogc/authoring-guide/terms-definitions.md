...
const outputKey = 'author/ogc/authoring-guide/terms-definitions'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/ogc/authoring-guide/terms-definitions.json')
