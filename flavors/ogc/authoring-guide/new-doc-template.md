...
const outputKey = 'author/ogc/authoring-guide/new-doc-template'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/ogc/authoring-guide/new-doc-template.json')
