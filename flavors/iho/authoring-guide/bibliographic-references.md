...
const outputKey = 'author/iho/authoring-guide/bibliographic-references'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/iho/authoring-guide/bibliographic-references.json')
