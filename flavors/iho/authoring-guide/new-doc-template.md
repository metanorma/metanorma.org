...
const outputKey = 'author/iho/authoring-guide/new-doc-template'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/iho/authoring-guide/new-doc-template.json')
