...
const outputKey = 'author/iho/authoring-guide/text-formatting'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/iho/authoring-guide/text-formatting.json')
