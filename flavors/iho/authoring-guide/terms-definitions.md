...
const outputKey = 'author/iho/authoring-guide/terms-definitions'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/iho/authoring-guide/terms-definitions.json')
