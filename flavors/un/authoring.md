---
title: "Syntax for writing UN documents using Metanorma"
layout: page
---
...
const outputKey = 'author/un/authoring'

onMounted(async () => {
  try {
    const mod = await import('../../../.vitepress/mirror-json/author/un/authoring.json')
