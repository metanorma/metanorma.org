---
title: "Metanorma presentation XML and ISO/NISO STS mapping"
layout: page
---
...
const outputKey = 'author/iso/ref/sts-mapping'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/iso/ref/sts-mapping.json')
