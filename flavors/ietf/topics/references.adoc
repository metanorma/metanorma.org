...
* [[[ref2,1]]] <1> span:surname[MacDonald] <2> span:initials[I]  <3>
span:date.published[1991] <4>
span:title[The New Shostakovich]  <5>
span:pubplace[Boston]
span:publisher[Northeastern University Press]
span:uri.HTML[https://www.amazon.co.uk/New-Shostakovich-Ian-MacDonald/dp/184595064X]  <6>
span:keyword[music] <7>
span:keyword[Soviet Union] <7>
span:abstract[Who was Dmitri Shostakovich? The USSR's official figurehead composer and son of the revolution that brought the Soviet state into being, or a secret dissident whose contempt for the totalitarian regime was scathing? Perhaps both?] <8>

--
<1> `back/references/reference/@anchor`
<2> `back/references/reference/front/author/@surname`
<3> `back/references/reference/front/author/@initials`
<4> `back/references/reference/front/date`
<5> `back/references/reference/front/title`
<6> `back/references/reference/@target`
<7> `back/references/reference/front/keyword`
<8> `back/references/reference/front/abstract`
...
hosted by the IETF in link:https://xml2rfc.tools.ietf.org/public/rfc/bibxml3/[], including 
