---
title: "Metanorma-IETF RFC XML version AsciiDoc comparison"
layout: page
---
...
const outputKey = 'author/ietf/topics/markup-v2tov3'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/ietf/topics/markup-v2tov3.json')
