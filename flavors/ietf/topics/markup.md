---
title: "Metanorma AsciiDoc markup (AsciiRFC v3)"
layout: page
---
...
const outputKey = 'author/ietf/topics/markup'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/ietf/topics/markup.json')
