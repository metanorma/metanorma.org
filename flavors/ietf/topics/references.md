...
const outputKey = 'author/ietf/topics/references'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/ietf/topics/references.json')
