---
title: "Metanorma AsciiDoc markup (AsciiRFC v2)"
layout: page
---
...
const outputKey = 'author/ietf/topics/markup-v2'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/ietf/topics/markup-v2.json')
