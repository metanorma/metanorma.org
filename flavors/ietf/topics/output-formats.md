...
const outputKey = 'author/ietf/topics/output-formats'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/ietf/topics/output-formats.json')
