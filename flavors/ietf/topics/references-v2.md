...
const outputKey = 'author/ietf/topics/references-v2'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/ietf/topics/references-v2.json')
