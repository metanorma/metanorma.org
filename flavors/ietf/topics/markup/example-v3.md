---
title: "Quick example of an RFC v3 I-D written using Metanorma AsciiDoc for RFC XML v3"
layout: page
---
...
const outputKey = 'author/ietf/topics/markup/example-v3'

onMounted(async () => {
  try {
    const mod = await import('../../../../../.vitepress/mirror-json/author/ietf/topics/markup/example-v3.json')
