---
title: "Quick example of an RFC v2 I-D written using Metanorma AsciiDoc for RFC XML v2"
layout: page
---
...
const outputKey = 'author/ietf/topics/markup/example-v2'

onMounted(async () => {
  try {
    const mod = await import('../../../../../.vitepress/mirror-json/author/ietf/topics/markup/example-v2.json')
