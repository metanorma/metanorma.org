---
title: "RFC element support in Metanorma-IETF"
layout: page
---
...
const outputKey = 'author/ietf/ref/unsupported-rfc-elements'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/ietf/ref/unsupported-rfc-elements.json')
