...
const outputKey = 'author/ieee/authoring-guide/metanorma-adoc'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/ieee/authoring-guide/metanorma-adoc.json')
