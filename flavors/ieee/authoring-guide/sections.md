---
title: "Typical sections in IEEE"
layout: page
---
...
const outputKey = 'author/ieee/authoring-guide/sections'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/ieee/authoring-guide/sections.json')
