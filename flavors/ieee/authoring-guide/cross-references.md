...
const outputKey = 'author/ieee/authoring-guide/cross-references'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/ieee/authoring-guide/cross-references.json')
