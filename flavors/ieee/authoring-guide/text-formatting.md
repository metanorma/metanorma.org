...
const outputKey = 'author/ieee/authoring-guide/text-formatting'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/ieee/authoring-guide/text-formatting.json')
