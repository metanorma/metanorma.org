...
const outputKey = 'author/ieee/authoring-guide/bibliographic-references'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/ieee/authoring-guide/bibliographic-references.json')
