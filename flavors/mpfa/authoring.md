---
title: "Authoring MPFA documents with Metanorma"
layout: page
---
...
const outputKey = 'author/mpfa/authoring'

onMounted(async () => {
  try {
    const mod = await import('../../../.vitepress/mirror-json/author/mpfa/authoring.json')
