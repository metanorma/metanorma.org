---
layout: iec-flavor
title: Metanorma IEC attribute notes
---

This page collects the stage-code mappings, translation tagging, and other
usage notes that accompany the
link:/flavors/iec/ref/document-attributes[Metanorma IEC document attributes]
reference. The attributes themselves (including `:partnumber:`,
`translated-from`, `:stage:`, `:docstage:` and `:docsubstage:`) are documented
there.
