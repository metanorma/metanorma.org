---
title: "Chinese standard types supported by Metanorma-GB"
layout: page
---
...
const outputKey = 'author/gb/topics/supported-types'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/gb/topics/supported-types.json')
