---
title: "Caveats regarding MS Word output"
layout: page
---
...
const outputKey = 'author/gb/topics/ms-word-output-caveats'

onMounted(async () => {
  try {
    const mod = await import('../../../../.vitepress/mirror-json/author/gb/topics/ms-word-output-caveats.json')
