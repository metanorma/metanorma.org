---
title: "Writing M3AAWG documents using Metanorma"
layout: page
---
...
const outputKey = 'author/m3aawg/authoring'

onMounted(async () => {
  try {
    const mod = await import('../../../.vitepress/mirror-json/author/m3aawg/authoring.json')
