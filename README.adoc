...
image:https://github.com/metanorma/metanorma.org/workflows/deploy-master/badge.svg["Build Status", link="https://github.com/metanorma/metanorma.org/actions?workflow=deploy-master"]
image:https://github.com/metanorma/metanorma.org/workflows/deploy-staging/badge.svg["Build Status", link="https://github.com/metanorma/metanorma.org/actions?workflow=deploy-staging"]
