...
image::/assets/author/tutorial/references_img_anchor.jpg[]
...
+
.Rendered reference
image::/assets/author/tutorial/references_img_target.jpg[]
...
+++
<div class="cta tutorial"><a class="button" href="/tutorial/lessons/lesson-2-5/">Start next lesson »</a></div>
+++