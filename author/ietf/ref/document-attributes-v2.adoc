...
[NOTE]
====
Below are listed only document attributes that are unique to Metanorma’s processing of RFC XML v2
...
`:toc-depth:`::     if `:toc-include:` is "yes", then this determines the depth of the table-of-contents
