...
`:presentation-metadata-render-document-annotations:` document attribute is present.
Editorial comments will also be included if `:notedraftinprogress:` 
is specified [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v3.5.9].
