...
Source notes and abbreviation notes are entered using the note types
"source" and "abbreviation" [added in https://github.com/metanorma/metanorma-un/releases/tag/v0.3.11]:
