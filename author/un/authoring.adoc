...
`plenary-attachment`:: Attachment to UN Plenary document (used to select plenary cover page)
`addendum`:: Addendum
...
Paragraph numbering is enabled for all docuument types but `plenary`, `agenda`,
