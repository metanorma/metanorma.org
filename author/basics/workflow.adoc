...
For organizations using the Metanorma release pipeline, publishing is automated:
pushing to `main` triggers compilation and creates a GitHub Release with the
document files and metadata. See
