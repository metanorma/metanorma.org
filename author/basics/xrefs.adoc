...
link:/author/topics/inline-markup/links[Adding links and cross-references]
...
Read more about link:/author/topics/inline-markup/citations#localities[localities and locality values] in the Bibliography documentation.
