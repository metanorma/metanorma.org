...
the bibliography. A switch to title and bibliographic number can be indicated by
setting the style of the reference to `style=title%` [added in
https://github.com/metanorma/metanorma-ieee/releases/tag/v1.5.4].
...
References to the bibliography that have render text suppliedare by default assumed to be using a
variant form of the title or of author names. Metanorma will automatically append the bibliographic
number after them.
