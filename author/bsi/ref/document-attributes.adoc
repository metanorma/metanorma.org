...
`:presentation-metadata-color-secondary-shade-2:`:: Colour (lighter accents) on PDF even table header rows (BSI Flex and PAS only), as #HEX.
`:presentation-metadata-color-secondary-shade-3:`:: Colour (even lighter accents) on PDF odd table body rows (BSI Flex and PAS only), as #HEX.
