...
Collection cover page style determines by 1st document type in the collection.
Style can be choose by the attribute `coverpage-style:` in the collection manifest file:
```
directives:
  - coverpage-style: ...
```
