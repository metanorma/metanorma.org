...
Available at: https://www.en-standard.eu/ieee-528-2019-ieee-standard-for-inertial-sensor-terminology-2/
----
====
...
. Cite a particular locality of the document, by cross-referencing the anchor name but additionally specify a link:/author/topics/document-format/xrefs/#localities[locality] as the second argument, like this: `\<<IHO_528-2019,part=IV,chapter=3,paragraph=12>>`.
