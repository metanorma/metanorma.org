...
`:semantic-metadata-annex-informative:`:: Indicate in the title that the annex is informative: set to `true` if so [added in https://github.com/metanorma/metanorma-iho/releases/tag/v1.1.10].
