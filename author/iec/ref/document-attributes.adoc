...
`:accessibility-color-inside:`:: indication that document contains colour content (default: `false`) [added in https://github.com/metanorma/metanorma-iec/releases/tag/v1.2.10]
