...
`:price-code:`:: price code group of publication, as documented in 
https://www.iec.ch/members_experts/tools/pdf/IEC_DATA_FEEDS.pdf[] [added in https://github.com/metanorma/metanorma-iec/releases/tag/v1.2.10]
