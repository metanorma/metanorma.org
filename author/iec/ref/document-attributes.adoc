...
In general, document attributes for ISO and IEC documents are identical.
Please refer to
https://www.metanorma.com/author/iso/ref/document-attributes[Metanorma-ISO document attributes]
for a detailed listing of shared attributes that apply.
...
This attribute takes a document identifier in the Relaton format:
