...
In order to avoid ambiguity (is "Figure I.3" part of the first Appendix, or the ninth Annex?),
the letter I is not used to number Annexes; annexes skip from Annex H to Annex J.
