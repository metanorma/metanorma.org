...
`:legacy-sequential-object-numbering:`::
If set, do not restart numbering objects (equations, tables, figures etc.) each clause, but number
them consecutively throughout the body of the document [added in https://github.com/metanorma/metanorma-itu/releases/tag/v1.0.11].
