...
* `position` applies to `add` clauses, and indicates whether the additional text is to be
inserted before or after the locality [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v3.3.0].
Legal values are `before` and `after`.
