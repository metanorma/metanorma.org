...
So assuming that the current Metanorma flavour differentiates concept mentions and
...
where _cross-reference-text_ hyperlinks to the concept _term_, as identified by its anchor
`identifier`.
