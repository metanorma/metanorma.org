...
NOTE: Variant titles are also used automatically to generate the Table of Content
entry for annex titles: these remove the clause obligation from the annex title,
and remove boldface introduced to keep the obligation 
in plain text  [added in https://github.com/metanorma/isodoc/releases/tag/v3.4.8].
