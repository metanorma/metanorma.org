...
layout: author-docs
---
// Check with content from tutorials; remove sections that are discussed in entering_bib.adoc; Put relaton info into relaton concept
...
////
This is from xrefs. Check how to incorporate into bibliography
=== Cross-references to external documents

In link:/author/topics/sections/bibliography#localities[localities and locality values],
anchors can be integrated in citations of documents via references; for example:
