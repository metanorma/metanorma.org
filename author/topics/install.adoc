...
Assuming you know what you’re doing, you can get the Metanorma CLI gem installed
(which installs the main `metanorma` binary and pulls the respective official flavor gems).
Note that you will have to take care of dependencies.
