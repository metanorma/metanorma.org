...
the list. The tag `statement` is treated as a synonym of `description` [added in https://github.com/metanorma/mn-requirements/releases/tag/v0.2.1].
...
description:: See also xref:http://www.example.com/req/class1/req1[].
----
-----
