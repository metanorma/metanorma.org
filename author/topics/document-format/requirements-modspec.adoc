...
requirement cross-references rendered within that requirement.
...
----
identifier:: http://www.example.com/req/class1/req1
description:: See also xref:http://www.example.com/req/class2/req2[style=id%].
----

[requirement]
----
identifier:: http://www.example.com/req/class2/req2
description:: See also xref:http://www.example.com/req/class1/req1[style=id%].
----
-----
...
h| Requirement | /req/class2/req2
|===

|===
2+| Requirement 1

h| Identifier  | http://www.example.com/req/class1/req1
h| Included in | /class1
...
h| Identifier  | http://www.example.com/req/class2/req2
h| Included in | /req/class2
h| Statement   | See also /req/class1/req1
|===
____
====
