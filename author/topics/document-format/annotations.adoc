---
layout: author-docs
title: Semantic annotations (editor notes, reviewer notes, to-dos)
---
...
Metanorma provides semantic annotation capability and allows the standards body,
and/or the standard's author or editor, to encode annotations in support for
the draft circulation process.

Semantic annotations in Metanorma are rendered across all general output
formats, including:
...
Metanorma supports the following types of semantic annotation mechanisms,
including:
...
* link:/blog/2022-08-21-semantic-annotations-available-in-all-ouputs/[Metanorma blog: Semantic annotations now available in all Metanorma outputs]
