...
By default, these are interpreted as hierarchically refinining a single location in a text,
through consecutive narrower localities (e.g. "Part IV, Chapter 3, paragraph 12": 
`<<ref1,part=IV,chapter=3,paragraph=12>>`); discontinuous
localities can be named by repeating the same locality type (e.g. "page 4, page 7":
`<<ref1,page=4,page=7>>`).
...
(e.g. "Part IV, Chapter 3; Part VI, Chapter 9": `<<ref1,part=IV,chapter=3;part=VI,chapter=9>>`).
