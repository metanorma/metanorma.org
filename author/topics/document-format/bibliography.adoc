...
Metanorma allows formatting within the named reference tag, even including 
footnotes [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v2.0.3]. However, we advise
against using this functionality, as it can lead to unexpected results and problems with copy-pasting.
