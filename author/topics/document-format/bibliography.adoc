...
if the hyperlink is local, Metanorma will look for an XML or RXL (Metanorma XML or
Relaton XML) file at the nominated location with the same filename, and read in the
