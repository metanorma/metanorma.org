...
`<<ref1,clause=3.2;and!clause=4.7;and!clause=4.9;and!clause=9>>`. Internationalisation during
rendering will take care of separating the references by colon, and inserting "and".
