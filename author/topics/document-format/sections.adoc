...
The hierarchical structure of standards documents is critical to their proper referencing, and
standards document do not normally include floating titles (titles outside the numbered hierarchy
of clauses). Nonetheless, floating titles (known in Asciidoctor as discrete titles) are
