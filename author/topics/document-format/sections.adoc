...
Normally in Metanorma, Terms & Definitions, Symbols & Abbreviated Terms, and
Bibliographic References are contained in a main clause. However, it is possible
for those clauses to be contained in annexes instead; in fact, this is done by default
for Terms and References in the NIST flavour of Metanorma.

In rendering, these annexes are treated the same as Terms & Definitions, Symbols & Abbreviated Terms, and
Bibliographic sections. However, neither the Metanorma information model, nor Asciidoctor
markup permit a clause to be an annex and a terms clause, or a bibliographic clause simultaneously.
