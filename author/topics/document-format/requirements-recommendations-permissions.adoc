...
Can contain multiple semicolon-delimited labels.
[added in https://github.com/metanorma/metanorma-standoc/releases/tag/v1.3.14].
Multple instances of `inherit` can also be expressed with the `inherit` macro,
which can contain markup including crossreferences, 
e.g. inherit:[<<ref1>>] [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v1.3.21].
