...
* link:/author/topics/document-format/requirements-default[Metanorma MMR: `basic`]
...
However, this syntax only works well for less attributes with shorter values.
