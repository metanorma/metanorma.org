...
* `term`: the term being cited (mandatory). The term can be named using any of
the preferred designations. It can also be named using 
an admitted designation [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v2.0.5].
