...
Grammar is encoded as keys within `grammar`:

grammar:gender:: the gender of the designation; legal values are `masculine`, `feminine`, `neuter`, `common`. Multiple values are allowed, comma delimited
grammar:isPreposition:: the designation is a preposition; value is boolean
grammar:isParticiple:: the designation is a participle; value is boolean
grammar:isAdjective:: the designation is an adjective; value is boolean
grammar:isVerb:: the designation is a verb; value is boolean
grammar:isAdverb:: the designation is an adverb; value is boolean
grammar:isNoun:: the designation is a noun; value is boolean
grammar:grammarValue:: other miscellaneous grammatical information
...
type:: full
:language: fre
:grammar:gender: masculine, feminine
----
