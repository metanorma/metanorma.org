...
To stay on the safe side, it is recommended just using _Terms and definitions_
for any case; the clause title will render accordingly. It doesn't matter
if the same text is repeated afterwards as a subclause. For example, this would
be a valid encoding:
