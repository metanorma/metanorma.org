...
The "`Terms and definitions`" sections follow a strict data input scheme:
...
[example]
.Using many term options, with examples, notes and source
====
[source,asciidoc]
--
[[paddy]]
...
=== Modification of sourced concepts
...
=== Source concepts from a termbase
...
[example]
.An IEC Electropedia (IEV) reference
====
...
In ISO, terminological entries are technically identified by identifiers, not
clauses.
...
=== Specifying concept domain, subject and usage information
...
NOTE: This is supported in ISO 10241-1.
...
.Setting a terminology source for the terms and definitions clause
[example]
====
[source,asciidoc]
--
