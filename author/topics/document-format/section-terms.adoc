...
`seealso`:: in order to better understand the current concept, refer in addition to the
nominated concept [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v2.1.3]. 
