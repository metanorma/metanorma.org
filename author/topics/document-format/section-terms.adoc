...
`field-of-application`:: text indicating the field of application of the term (typically the domain),
and used to disambiguate the designation from other designations identical in the current language.
...
`usage-info`:: text used to disambiguate the designation from other designations identical in the current language,
but not relating to the field of application of the term [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v1.11.2].
