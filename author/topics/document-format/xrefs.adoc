...
this option is currently only used in IETF. This is specified by prefixing the text in the URL macro
with `style=...,`:
...
[source,adoc]
--
http://www.example.com[style=brackets,text to go into the hyperlink]
--
====
