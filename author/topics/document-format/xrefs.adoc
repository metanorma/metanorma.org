...
If an anchor is not assigned to an entity, AsciiDoc by default assigns GUIDs to be
...
Metanorma replaces such GUIDs with a GUID calculated through an MD5 Hash of
