...
* `identifiers`: The identifiers of all documents in the collection, in the 
depth-first order they appear in the manifest. [added in https://github.com/metanorma/metanorma/releases/tag/v1.5.6]
* `titles`: The titles of all documents in the collection, in the 
depth-first order they appear in the manifest. [added in https://github.com/metanorma/metanorma/releases/tag/v1.5.6]
