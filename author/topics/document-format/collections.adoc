...
attachment, and is passed through [added in
https://github.com/metanorma/metanorma/releases/tag/v1.2.9].

** If `index` is false (true by default), the file is not to be included in any
listing of manifest contents (i.e. in the collection coverpage). [added in
