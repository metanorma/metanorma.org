...
* `docrefs`: Identification of all constituent documents, in depth-first order;
an array of objects, consisting of identifier, title, level, file [added in https://github.com/metanorma/metanorma/releases/tag/v1.5.6].
