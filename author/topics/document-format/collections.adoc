...
The `embed:[]` macro acts like the Asciidoctor `:include:[]` macro, taking as its argument
the name of the file to be included. The named file is included at the location of the `embed:[]`
macro, with the following provisos:
