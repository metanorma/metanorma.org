...
Multi-paragraph footnotes are not natively supported in Asciidoctor. In order to generate
such footnotes, use the macro `footnoteblock:[id]` [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v1.6.4],
