...
Unlike normal AsciiDoc, Metanorma adds the option of multiple header rows
...
`longdesc`, both of which are to be rendered as a summary of the table
for accessibility:

[source,asciidoctor]
--
[headerrows=2,alt=Table of maximum mass fraction of defects in husked rice,longdesc=Table enumerating the permissible mass fraction of defects in husked and various classes of milled rice]
|===
