...
In most flavours, equations and inequalities are both referenced in the same way, as formulae.
In some flavours (e.g. ITU), they are differentiated as Equations and Inequalities.
