...
For example, "ISO 7301, Clause 2, Table 1a, pp. 7-9" would be expressed as:
...
Under link:bibliography#localities[localities and locality values],
we saw that anchors can be integrated in citations of documents via references.

Outside of that, Metanorma will process cross-references to anchors within external documents
