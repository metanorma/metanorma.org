...
Rarely, term notes need to be presented in isolation (e.g. in ISO Amendments); to achieve that,
mark the note up with `termnote=true` [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v2.1.2].
...
Rarely, term examples need to be presented in isolation (e.g. in ISO Amendments); to achieve that,
mark the example up with `termexample=true` [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v2.1.2].
