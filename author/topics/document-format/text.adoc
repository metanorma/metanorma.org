...
All figures, tables, examples, formulas, sourcecode snippets,
...
Sourcecode and pseudocode snippets are numbered as figures
...
----
Unnumbered sourcecode
----
--

Tables, sourcecode and pseudocode, and figures are also excluded from autonumbering
if they are included in a block type that is already subject to numbering,
including examples, requirements, recommendations, permissions, tables, figures,
sourcecode and pseudocode. [added in https://github.com/metanorma/isodoc/releases/tag/v1.0.11]
