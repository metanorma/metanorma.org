...
image::captures/text/fig-strike-small.png[]
...
image::captures/text/fig-par-align.png[]
...
.Left-aligment for multiple line-breaks in paragraph in Metanorma.
image::captures/text/fig-left-aligned.png[]
...
.Illustration of a quote block in Metanorma
image::captures/text/fig-block-quote.png[]
...
image::captures/text/fig-table.png[]
...
.Example of an equation block in Metanorma
image::captures/text/fig-stem-equality.png[]
...
.Example of inequation block in Metanorma
image::captures/text/fig-stem-inequality.png[]
