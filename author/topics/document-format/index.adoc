...
contents for HTML and PDF documents [added in https://github.com/metanorma/isodoc/releases/tag/v1.8.5].
They are not used in DOC, because tables of contents for Word documents are generated
dynamically from the current heading.
