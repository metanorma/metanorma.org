...
the link:/author/topics/document-format/section#misc-container[`metanorma-extension` clause] of the document,
...
embedded in the link:/author/topics/document-format/section#misc-container[`metanorma-extension` clause] of the document,
