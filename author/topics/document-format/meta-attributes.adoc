...
Asciidoc formatting such as lists and tables.
`classification`:: A list of key/value pairs used to classify the change, which can be used for filtering in the rendering of the document history.
