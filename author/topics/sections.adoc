...
https://www.metanorma.org/flavors/[flavor documentation] for more details on how
...
NOTE: Documents can contain only one Abstract, one Acknowledgements section, and one Index.
