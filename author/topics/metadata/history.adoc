...
link:/author/topics/document-format/section#misc-container[`metanorma-extension` clause], which in turn houses the YAML as a source block
under its `document history` subclause.
