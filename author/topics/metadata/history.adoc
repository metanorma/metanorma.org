...
link:/author/topics/inline-markup/changes[machine-readable content changes].
...
notations, using the
link:/author/topics/inline-markup/citations#locality-types[Metanorma locality notation],
as with bibliographic cross-references.
+
Valid values are listed at the
link:/author/topics/inline-markup/citations#locality-types[Metanorma locality notation] page.
+
