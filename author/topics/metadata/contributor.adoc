...
This is a basic discussion of how contributors are specified in document metadata.
More comprehensive information, and a broader set of options is given in
link:/author/ref/document-attributes/#author-information[Document attributes: Author information],
and in the document attributes discussion for specific flavors.

Multiple instances of contributors are specified by suffixing a number to the
...
Contributor groups of organizations, i.e. editorial committees, are specified using document attributes.

ISO-aligned standards (including ISO itself) break their committee down as technical committees,
subcommittees, and workgroups, and these are specified accordingly:
...
For different flavors, the legal types of committee, used instead of "technical-committee", "subcommittee", etc.,
are:

Default:: technical-committee
BIPM:: committee, workgroup
CalConnect:: technical-committee
Ribose:: committee
CSA:: committee
IHO:: committee, workgroup, commission
IEEE:: society, balloting-group, working-group, committee
IETF:: workgroup
ITU:: bureau, sector, group, subgroup, workgroup
NIST:: technical-committee, subcommittee, workgroup
OGC:: committee, subcommittee, workgroup

By default, the corporate author of the document is assumed to be the same as
the publishing organization. This can be overridden with `:corporate-author:`

Default values for both the corporate author and the publisher are set in each
Metanorma flavour.

The following attributes can be specified for each contributor group type:

`{group}`:: the name of the group
`{group}-number`:: the unprefixed identifier of the group
`{group}-type`:: the type of the group, as an abbreviation; the identifier of the group is assumed to be type + number, e.g. _TC 2_
`{group}-agency`:: the agency that the group lies under, in case of multiple groups
`{group}-agency-abbr`:: the abbreviation of the agency that the group lies under, in case of multiple groups
`{group}_logo`:: the logo of group

.Example of multiple groups and subgroups
====
...
:workgroup-number: 9
:workgroup-type: WG
:technical-committee_2: Technical solutions sub-group
:technical-committee-number_2: TS
:technical-committee-type_2: SG
:technical-committee-agency_2: British Standards Institute
:technical-committee-agency-abbr_2: BSI
:technical-committee_logo_2: bsi.svg
====
