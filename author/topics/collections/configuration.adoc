...
The attribute is set by default to `true`, and needs to be explicitly set to `false`
in order to prevent recompilation [added in https://github.com/metanorma/metanorma/releases/tag/v2.1.10].
