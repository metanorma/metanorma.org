...
`render`:: (optional) The requirement model rendering that applies to the instance.
(default: `default`) Legal values are `default` and `inline` [added in https://github.com/metanorma/mn-requirements/releases/tag/v0.6.0]
