...
link:/author/topics/inline-markup/links[internal reference] mechanism.
...
To fix the relative widths of the table columns, add the attribute
...
.Using `display-directives` to specify column widths
[example]
====
[source,adoc]
----
