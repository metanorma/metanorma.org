...
A single model has a default rendering, but can be rendered in
different ways [added in https://github.com/metanorma/metanorma-standoc/releases/tag/3.4.1].
...
`render`:: The requirement model rendering that applies 
to the instance. [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v3.4.1]
