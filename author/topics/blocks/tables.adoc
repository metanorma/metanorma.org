...
`background-color`, `color`, and [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v3.0.7]
`border` and the associated `border-*` attributes, such as `border-width` and `border-top-style`.
