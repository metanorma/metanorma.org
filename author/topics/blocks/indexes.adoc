...
NOTE: Formerly, only the ISO, IETF and BIPM flavours render
index terms. Index terms can now be rendered in any Metanorma flavor [added in https://github.com/metanorma/isodoc/releases/tag/v3.4.3].
