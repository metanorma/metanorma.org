...
NOTE: From Metanorma Isodoc v3.4.3 onwards, index terms are rendered in all
Metanorma flavors. Prior to that version, only the ISO, IETF and BIPM flavours
render index terms.
 [added in https://github.com/metanorma/isodoc/releases/tag/v3.4.3].
