---
layout: author-docs
title: Deep-dive into cross-references
description: This article looks at the technical details of cross-references in Metanorma AsciiDoc. If you want to learn how to insert cross-references, read link:/author/topics/inline_markup/links[Adding links and cross-references]
---
== Basic anchor syntax
...
=== Dropping cross-reference labels and prefixes
