---
layout: author-docs
title: Automatic numbering in Metanotma
---
tag::auto-num-intro[]
...
You can also override the numbering style in ordered lists, for example instead of latin numbers, you could use alphabetic numbering. 
For more information, refer to the https://www.metanorma.org/author/topics/blocks/lists/[Documentation].

NOTE: Not all flavors support these style tags.
