...
In the case of `--`, the substitution with en-dash is done a couple of times in the lifecycle
of Metanorma. To prevent that substitution, and in general to prevent the substitution of
