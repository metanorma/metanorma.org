...
`:localize-number:`::
Template for how to present localised numbers [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v2.2.4]. The string has the following form:
+
`:localize-number: +++#,##0.### ###+++`
+
See link:/author/topics/languages#number-localisation[Number Localisation] for how numbers are localised in Metanorma.
