...
[note]
--
Since `:docidentifier:` is a preformatted value, and it is opaque to Metanorma. This means that Metanorma cannot
...
`:doctype-abbrev:`::
The document type abbreviation; e.g. `TN` for "technical note"  [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v3.3.0]. Can be used in document metadata, e.g. cover page.
...
`:docstage-abbrev:`::
The document stage abbreviation; e.g. `D` for "draft"  [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v3.3.0]. Can be used in document metadata, e.g. cover page.
`:docstage-published:`::
Whether the current document stage should be considered as published [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v3.3.0]. Boolean. If not provided, and if there is no setting specific to the flavor, the default is that only the stage "published" is considered published.
