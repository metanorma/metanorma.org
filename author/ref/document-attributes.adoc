...
`:vote-started-date:`::
The date on which voting starts for the current draft of the standard [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v1.3.25].

`:vote-ended-date:`::
The date on which voting ends for the current draft of the standard [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v1.3.25].
