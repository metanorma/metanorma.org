...
The attributes in this section take a document identifier, in Relaton format.
If the document can be found via Relaton auto-fetch (e.g. a published ISO standard), the actual bibliographic item will be used.
