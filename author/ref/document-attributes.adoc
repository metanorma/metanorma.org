...
Sort the bibliographies in the document according to criteria set by the SDO
 [added in https://github.com/metanorma/metanorma-standoc/releases/tag/3.2.5]. The default value for
...
specified as an image file [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v3.2.5].

`:committee-types:`:: Comma-delimited list of committee types to be recognised 
for the document  [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v3.2.5].
...
Override the default rendering of cross-references to bibliographic entries
 [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v3.2.5].
