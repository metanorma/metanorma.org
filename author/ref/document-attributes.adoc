...
as an icon in front of the label for all admonitions of type `{type}`;
overrides any value given in `admonition-icon` under the `i18n` internationalisation file
