...
No attribute value needed. [added in
...
Base for Modspec identifiers throughout the document, to be stripped from any identifiers
used to cross-reference Modspec requirements. See
link:/author/topics/document-format/requirements-modspec/#identifier-base[Modspec identifier bases]. [added in https://github.com/metanorma/metanorma-standoc/releases/tag/v2.2.7].
