...
In PDF, cross-references are accompanied by a page number, preceded by _see_/_voir_. If the cross-reference is formatted as `\<<{{anchor}},nosee%>>`, that _see_/_voir_ is not inserted.
