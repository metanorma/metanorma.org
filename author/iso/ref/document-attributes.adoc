...
`dis`::: using the styles of the "ISO Edited DIS template", introduced by the ISO editors at the DIS stage of editing, through
to publication.
...
(equivalent to "Pattern: Clear"), and is `true` by default [added in https://github.com/metanorma/metanorma-iso/releases/tag/v2.2.3].
