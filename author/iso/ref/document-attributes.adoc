...
`supplement`::: Supplement (Suppl) [added in https://github.com/metanorma/metanorma-iso/releases/tag/v3.4.6]
`extract`::: Extract (Ext) [added in https://github.com/metanorma/metanorma-iso/releases/tag/v3.4.6]

`:updates-document-type:`::
(only when `doctype` is set to `amendment`, `technical-corrigendum`, `addendum`, `supplement`, or `extract`)
The document type that this amendment, technical corrigendum, addendum, supplement or extract is
...
`:title-supplement-{en,fr}:`:: (only when `doctype` is set to `supplement`)
The English or French title of the supplement [added in https://github.com/metanorma/metanorma-iso/releases/tag/v3.4.6]

`:title-extract-{en,fr}:`:: (only when `doctype` is set to `extract`)
The English or French title of the extract [added in https://github.com/metanorma/metanorma-iso/releases/tag/v3.4.6]
...
`:supplement-number:`:: (only when `doctype` is set to `supplement`)
The number of the supplement [added in https://github.com/metanorma/metanorma-iso/releases/tag/v3.4.6]

`:extract-number:`:: (only when `doctype` is set to `extract`)
The number of the extract [added in https://github.com/metanorma/metanorma-iso/releases/tag/v3.4.6]
...
`:technical-committee-agency:`:: The agency that the technical committee lies under,
if it is other than the home agency 
(ISO for metanorma-iso, IEC for metanorma-iec) [added in https://github.com/metanorma/metanorma-iso/releases/tag/v3.1.2]
Can be given as an abbreviation if it is IEC or ISO.

`:technical-committee-agency-abbr:`:: The abbreviation of the agency that the technical committee 
lies under [added in https://github.com/metanorma/metanorma-iso/releases/tag/v3.1.2].
Should be given if the agency is other than IEC or ISO.
...
attribute where `n` is a sequential number after 1. Each suffix corresponds to
one nesting grouping of technical committee, subcommittee, and working group.
+
[example]
