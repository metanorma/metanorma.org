...
The options are "simple", using the styles of the ISO Simple Template, and "dis",
using the styles introduced by the ISO editors at the DIS stage of editing, through
to publication. If the option is not supplied, the default value is "simple" for
