...
`:tc-docnumber:`:: The document number assigned by the Technical Committee. Must include the approval group prefix, since
documents may circulate widely; e.g. "ISO/TC 154 N 1218", not just "N 1218".
...
[example]
.Setting one or multiple publishers
====
EXAMPLE:
...
`:approval-group-id:`:: The identifier of the ISO editorial committee responsible for
approving a draft [added in https://github.com/metanorma/metanorma-iso/releases/tag/v2.1.2].
Normally this is the technical committee or subcommittee, but this provides
the option to provide this explicitly.
