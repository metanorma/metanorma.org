...
`:classification:`:: The Universal Decimal Classification (Dewey) for the standard, used instead of the ICS
...
and comma delimited; e.g. `:classification: UDC:563.5.081, UDC:537.71`.
