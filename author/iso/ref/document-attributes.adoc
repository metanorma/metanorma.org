...
`:approval-group-id:`:: The identifier of the *approval group*. The approval
group is typically the ISO Technical Committee, Subcommittee or Working Group
responsible for approving a
draft [added in https://github.com/metanorma/metanorma-iso/releases/tag/v2.1.2].
If not provided, the editing group is assumed to also be the approval group. +
+
[example]
...
[source,adoc]
----
:approval-group-id: ISO/TC 154/WG 5
----
====
