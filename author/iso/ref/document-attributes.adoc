...
(only when `doctype` is set to `amendment`, `technical-corrigendum`, `addendum`, or `supplement`)
The document type that this amendment, technical corrigendum, addendum or supplement is
