...
Vocabulary documents usually do not contain a clause for Symbols and Abbreviated terms. 
Preferably, those are included in term entries as preferred or admitted terms.
Alternatively they can be listed in an annex.
