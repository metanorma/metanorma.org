...
and 2024 and 2025 updates [added in https://github.com/metanorma/metanorma-iso/releases/tag/v3.1.1].
...
https://www.iso.org/ISO-house-style.html#iso-hs-s-text-r-s-family["family of standards" and "suite of standards"]:
Warn of ambiguous wording.
