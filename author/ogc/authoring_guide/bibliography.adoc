...
* Informative references (also called the Bibliography)

In OGC deliverables, these are the two sections that contain them:

* "`Normative references`", contain normative references;
* "`References`", contain informative references.

The "`Normative references`" section is
