...
:external-id: http://www.opengis.net/doc/IS/ogcapi-features-1/1.0 <4>
----
<1> OGC document title.
<2> OGC document number.
<4> OGC External ID for this deliverable.
...
:submitting-organizations: CubeWerx Inc.; Heazeltech LLC; Hexagon; ... <4>
----
