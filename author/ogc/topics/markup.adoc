...
It can also be indicated with the style attribute 
...
The following style attributes can be used instead of `[.preface]`, to indicate
prefatory material specific to engineering reports [added in https://github.com/metanorma/metanorma-ogc/releases/tag/v2.6.0].
...
These are all treated as equivalent to `[.preface,type=...], independent of the actual title provided:
...
This is in fact a value proposition

== Initial clause

This is where the main section of the document begins
