...
Any table included in a Submitters section is automatically 
...
with the title "Glossary", or marked up 
with `[heading=glossary]` [added in https://github.com/metanorma/metanorma-ogc/releases/tag/v1.4.1]. 
