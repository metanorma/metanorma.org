...
definition list within the requirement. In addition, the entries `test-purpose`, `test-method`,
`conditions`, and `part` will be recognised as components of those types [added in https://github.com/metanorma/metanorma-ogc/releases/tag/v1.4.2].
