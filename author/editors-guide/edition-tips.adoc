...
When exporting SVG files from Adobe Illustrator for inclusion in Metanorma documents, rendering issues may arise if the export options are not properly configured. Use this following setup to ensure proper rendering across different output formats:
