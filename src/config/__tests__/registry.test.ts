...
describe('SidebarRegistry', () => {
  ...
  it('generated sub-paths of hand-authored prefixes ARE suppressed — hand-authored tree wins', () => {
    ...
    // NOT the generated /author/basics/ flat list. The hand-authored
    // tree shows for ALL pages under /author/.
