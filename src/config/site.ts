...
export const nav: NavigationItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'ISO', link: '/author/iso/' },
      { text: 'IEC', link: '/author/iec/' },
      { text: 'IEEE', link: '/author/ieee/' },
      { text: 'IETF', link: '/author/ietf/' },
      { text: 'ITU', link: '/author/itu/' },
      { text: 'OGC', link: '/author/ogc/' },
      { text: 'BIPM', link: '/author/bipm/' },
      { text: 'BSI', link: '/author/bsi/' },
      { text: 'NIST', link: '/author/nist/' },
      { text: 'CalConnect', link: '/author/cc/' },
      { text: 'IHO', link: '/author/iho/' },
      { text: 'JIS', link: '/author/jis/' },
      { text: 'PLATEAU', link: '/author/plateau/' },
    ],
  },
  {
    text: 'Develop',
