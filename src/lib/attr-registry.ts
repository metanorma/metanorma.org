...
export const ATTRIBUTE_PAGES: readonly AttrPage[] = [
  ...
  {
    urlPath: 'flavors/iec/ref/document-attributes',
    manifestId: 'iec',
    title: 'Metanorma IEC document attributes',
    flavorId: 'iec',
    page: 'document-attributes',
  },
  {
    urlPath: 'flavors/ieee/ref/document-attributes',
    manifestId: 'ieee',
    title: 'Metanorma IEEE SA document attributes',
    flavorId: 'ieee',
    page: 'document-attributes',
  },
  {
    urlPath: 'flavors/itu/ref/document-attributes',
    manifestId: 'itu',
  ...
  {
    urlPath: 'flavors/jis/ref/document-attributes',
    manifestId: 'jis',
    title: 'Metanorma JIS document attributes',
    flavorId: 'jis',
    page: 'document-attributes',
  },
  {
    urlPath: 'flavors/iho/ref/document-attributes',
    manifestId: 'iho',
    title: 'Metanorma IHO document attributes',
    flavorId: 'iho',
    page: 'document-attributes',
  },
  {
    urlPath: 'flavors/nist/ref/document-attributes',
    manifestId: 'nist',
    title: 'Metanorma NIST document attributes',
    flavorId: 'nist',
    page: 'document-attributes',
  },
  {
    urlPath: 'flavors/bsi/ref/document-attributes',
    manifestId: 'bsi',
    title: 'Metanorma BSI document attributes',
    flavorId: 'bsi',
    page: 'document-attributes',
  },
  {
    urlPath: 'flavors/gb/ref/document-attributes',
    manifestId: 'gb',
    title: 'Document attributes',
    flavorId: 'gb',
    page: 'document-attributes',
  ...
  {
    urlPath: 'flavors/plateau/ref/document-attributes',
    manifestId: 'plateau',
    title: 'Metanorma PLATEAU document attributes',
    flavorId: 'plateau',
    page: 'document-attributes',
  },
  {
    urlPath: 'flavors/ogc/ref/document-attributes',
    manifestId: 'ogc',
    title: 'Metanorma for OGC document attributes',
    flavorId: 'ogc',
    page: 'document-attributes',
  },
  {
    urlPath: 'flavors/bipm/ref/document-attributes',
    manifestId: 'bipm',
