...
under the repository prefix `mn-templates-{flavor}`. For example, the repository for CalConnect is located at https://github.com/metanorma/mn-templates-calconnect .
...
For example, at https://github.com/metanorma/mn-templates-calconnect you can see
