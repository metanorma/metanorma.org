...
This work was done for the ISO 2533 publication: at the FDIS stage we needed to distribute the changes the ISO/CS editors had made to the document, together with their disposition, to everyone following the ballot — in the same comment-sheet form as every other response.
