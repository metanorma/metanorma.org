...
'TODO's text: https://metanorma.org/author/topics/document-format/reviewer-notes/[Reviewer notes and comments]
...
* https://metanorma.org/author/topics/document-format/reviewer-notes/[Reviewer notes and comments]
