...
image::/assets/blog/2018-11-29.png[Clippy for your standards document,width=100%]
...
Then it might just be worth your while link:../../12-05-2018/intro-to-metanorma/[to try something different].
