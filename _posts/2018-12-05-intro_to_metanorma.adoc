...
Metanorma refers to three things:

* The Metanorma document metamodel, which allows different standardization bodies
...
Word (in the older Word DOC format).
...
The standards bodies currently supported are:
