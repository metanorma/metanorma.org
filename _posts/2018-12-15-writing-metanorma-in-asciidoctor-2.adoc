---
layout: post
title:  "Writing Metanorma in Asciidoctor, Part 2"
date:   2018-12-15
categories: about
author:
  name: Nick Nicholas
...
redirect_from:
  - /blog/12-15-2018/writing-metanorma-in-asciidoctor-2/
---
...
image::/assets/blog/2018-12-15.png[A more accurate depiction of the concluding stage of creating an Asciidoctor document,width=100%]
...
NOTE: This table example originates from the https://github.com/riboseinc/isodoc-rice[IsoDoc Rice document],
