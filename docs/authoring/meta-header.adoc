...
The convention is to provide those documents as part of document header.
...
Following is a reference for document attributes expected by most Metanorma flavours.
