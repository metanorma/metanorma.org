...
The `metanorma-iho` gem is the Metanorma processor for IHO documents.

* link:/library/metanorma-iho/[Library documentation] — synced from the upstream gem README.
* link:/author/iho/[IHO authoring guide] — how to author IHO documents with Metanorma.
