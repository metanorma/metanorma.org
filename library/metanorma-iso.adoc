---
title: Metanorma-ISO library documentation
description: >-
  Library documentation for Metanorma-ISO, the Metanorma flavor for ISO standards.
  Synced from the upstream gem README at github.com/metanorma/metanorma-iso.
source_url: https://github.com/metanorma/metanorma-iso/blob/main/README.adoc
is_library_doc: true
layout: page
---
...
$ metanorma --type iso --extensions doc a.adoc  # output just DOC
$ metanorma --type iso --extensions xml a.adoc  # output CSD XML
----
...
* Example documents are available at the https://github.com/metanorma/mn-samples-iso[mn-samples-iso] repository.
